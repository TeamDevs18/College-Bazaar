  ...
  <body>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item active">
              <a class="nav-link" href="/CollegeBazaar/index.php">Market
            ...
            <li class="nav-item">
              <a class="nav-link" href="/CollegeBazaar/login.php">Login</a>
            </li>
          </ul>
        </div>
      </div>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-3">
          <h1 class="my-4">College Bazaar</h1>
    ...
    <footer class="py-5 bg-dark">
      <div class="container">
        <p class="m-0 text-center text-white">Copyright &copy; College Bazaar 2018</p>
      </div>
      <!-- /.container -->
    </footer>
